    ...
    while (not result) and counter < max_retries:
        ...
        try:
            ...
            if account['level'] >= 30:
                ...
                # If we are here, we are using the original account. Thus, no need to retry.
                counter = max_retries
            ...
            if encounter_level < 30:
                ...
                # Remove from the set
                if using_accountset:
                    account_sets.remove_from_set('30', hlvl_account)
                continue
                #return False
...
def database_migrate(db, old_ver):
    ...
    if old_ver < 22:
        ...
        db.execute_sql(
            ...
            'form, weather_boosted_condition, last_modified ' +
            'FROM `pokemon_old`;')
        db.execute_sql(
